...
/* Open Dialog Provider */
  ...
  static void *Thread( void *obj )
  {
    ...
    vaf::Generical* unMuteArchetype = new vaf::Generical(actionManager, &ActionsManager::toggleMuteAudio);
    vocalib.getFunctions().add(muteArchetype);
    muteArchetype->getKeywords().add(vlang::FR, "muet");
    muteArchetype->getKeywords().add(vlang::EN, "unmute");
    ...
    snapshotArchetype->getKeywords().add(vlang::EN, "snapshot");
    ...
    fasterArchetype->getKeywords().add(vlang::FR, "rapide");
    fasterArchetype->getKeywords().add(vlang::EN, "faster");
    ...
    {
      vap::MultiString* multipleChoicesString = new vap::MultiString;
      multipleChoicesString->getNames().setName(vlang::FR, "nom de fichier");
      multipleChoicesString->getNames().setName(vlang::EN, "file name");
      ...
      for (; mediaFileListIterator != mediaFileList.end(); ++mediaFileListIterator)
      {
        ...
        {
          multipleChoicesString->getValues().add(mediaFileListIterator->path()).getKeywords().add(vlang::EN, *stringListIterator);
        }
      }
